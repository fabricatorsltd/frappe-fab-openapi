...
from fab_openapi.clients.base import get_default_endpoint_url, get_default_oauth_token_url, normalize_url


class OpenAPIConnection(Document):
	def validate(self):
		self.endpoint_url = normalize_url(self.endpoint_url) or get_default_endpoint_url(
			self.environment, self.service_type
		)
